    ...
    <div className="container mx-auto max-w-4xl px-3 py-4 sm:px-4 sm:py-6">
      <Card className="min-w-0 overflow-hidden">
        <CardHeader className="px-4 sm:px-6">
          <CardTitle className="text-xl font-bold sm:text-2xl">Điều khoản dịch vụ - Những ngày còn lại</CardTitle>
        ...
        <CardContent className="prose prose-sm dark:prose-invert max-w-none space-y-4 px-4 pb-6 sm:px-6 sm:prose-base">
          ...
          <h2 className="text-lg font-semibold mt-6 sm:text-xl">1. Chấp nhận điều khoản</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold mt-6 sm:text-xl">2. Tài khoản người dùng</h2>
          ...
          <h2 className="text-lg font-semibold mt-6 sm:text-xl">3. Sử dụng dịch vụ</h2>
          ...
          <h2 className="text-lg font-semibold mt-6 sm:text-xl">4. Tuyên bố miễn trừ trách nhiệm y tế</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold mt-6 sm:text-xl">5. Hành vi bị cấm</h2>
          ...
          <h2 className="text-lg font-semibold mt-6 sm:text-xl">6. Chấm dứt</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold mt-6 sm:text-xl">7. Giới hạn trách nhiệm</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold mt-6 sm:text-xl">8. Thay đổi điều khoản</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold mt-6 sm:text-xl">9. Liên hệ</h2>
          <p>
